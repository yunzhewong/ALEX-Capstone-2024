...
SAMPLE_PERIOD = 0.04
POLYNOMIAL_COEFFICIENTS = [0.0, 0.04, 0.016]  # Coefficients for the position reference
POLYNOMIAL_COEFFICIENTS_TOP = [0.0, 0.2, 0.048]  # Coefficients for the top motor velocity
POLYNOMIAL_COEFFICIENTS_BOTTOM = [0.0, 0.08, 0.048]  # Coefficients for the bottom motor velocity
...
def calculate_reference_position(running_time: float):
...
if __name__ == "__main__":
    ...
    def command_func(top_motor: SafeMotor, bottom_motor: SafeMotor, running_time):
        ...
        reference_position = calculate_reference_position(running_time)
        ...
        # Calculate errors
        error_top = reference_position - current_position_top
        error_bottom = reference_position - current_position_bottom
